...
export default function Model({ModelsKey}) {
    ...
    return (
        <div className={`container formContainer max-w-[500px] duration-75 shadow-sm bg-[#fff] mx-auto p-4 fixed left-[50%]  top-[${ModelForm===1 ? "50%" : "-1000px"}] translate-x-[-50%] translate-y-[${ModelForm===1 ? "-50%" : "-1000px"}] z-[99999] `}>
            <form className='flex flex-col'>
                <div className="formHeader  border-[#c1c1c1] py-3 relative"><h1 className='text-[24px] text-center font-bold border-b-1'>Download Brochure</h1><span onClick={()=>SetModelForm(0)} className='absolute cursor-pointer right-0 top-0'><RxCross1 />
                </span></div>
